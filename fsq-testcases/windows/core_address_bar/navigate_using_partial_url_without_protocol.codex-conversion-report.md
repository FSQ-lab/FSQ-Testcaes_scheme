...
| --- | --- | --- |
| `When I input "apple.com" in address bar` | `tapOn` | Converted from matched step implementation. |
...
| --- | --- | --- |
| `When I input "apple.com" in address bar` | `/Users/qunmi/Documents/MS_ADO/FSQ_AI_TestCases_Windows/features/steps/common.py:79` | operations=enter_text |
