...
- Output YAML: `fsq-testcases/windows/core_address_bar/navigate_using_partial_url_without_protocol.codex.yaml`
- Platform: `windows`
...
| --- | --- | --- |
| `When I input "apple.com" in address bar` | `tapOn, inputText, pressKey, waitUntil` | Conservative semantic conversion. |
...
| `And the address bar should display the complete URL "https://www.apple.com"` | `tapOn, inputText, pressKey, waitUntil` | Conservative semantic conversion. |
