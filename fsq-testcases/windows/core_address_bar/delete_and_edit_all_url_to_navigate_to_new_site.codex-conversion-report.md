...
| `And I press the "Backspace" key` | `pressKey` | Conservative semantic conversion. |
| `And I input "www.bbc.com" in address bar` | `tapOn, inputText, pressKey, waitUntil` | Conservative semantic conversion. |
