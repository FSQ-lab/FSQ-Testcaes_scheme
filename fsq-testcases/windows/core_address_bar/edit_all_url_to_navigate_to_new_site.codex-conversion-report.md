...
- Output YAML: `fsq-testcases/windows/core_address_bar/edit_all_url_to_navigate_to_new_site.codex.yaml`
- Platform: `windows`
...
| --- | --- | --- |
| `When I input "https://www.bbc.com" in address bar` | `tapOn` | Converted from matched step implementation. |
...
| `And I type "https://www.apple.com" in address bar` | `inputText` | Converted from matched step implementation. |
...
| --- | --- | --- |
| `When I input "https://www.bbc.com" in address bar` | `/Users/qunmi/Documents/MS_ADO/FSQ_AI_TestCases_Windows/features/steps/common.py:79` | operations=enter_text |
...
| `And I type "https://www.apple.com" in address bar` | `/Users/qunmi/Documents/MS_ADO/FSQ_AI_TestCases_Windows/features/steps/core_address_bar/core_address_bar.py:141` | operations=send_keystrokes |
