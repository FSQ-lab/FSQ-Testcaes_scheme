...
| --- | --- | --- |
| `Given I navigate to "https://www.apple.com"` | `executeMethod: native_navigate` | Preserves Windows pywinauto MCP `native_navigate` source operation. |
| `And I open a new tab` | `tapOn` | Converted from matched step implementation. |
| `When I input "www.app" in address bar` | `tapOn` | Converted from matched step implementation. |
...
| `When I input "www.app" in address bar` | `/Users/qunmi/Documents/MS_ADO/FSQ_AI_TestCases_Windows/features/steps/common.py:79` | operations=enter_text |
