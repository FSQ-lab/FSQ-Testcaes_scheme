...
- Scenario: `Navigate to HTTP website and verify not secure connection`
- Tags: `@navigation, @regression, @p0`

## Output

- Output YAML: `fsq-testcases/windows/core_address_bar/navigate_to_http_website_and_verify_not_secure_connection.codex.yaml`
- Platform: `windows`
...
| --- | --- | --- |
| `When I input "http://www.faqs.org/faqs/" in address bar` | `tapOn` | Converted from matched step implementation. |
| `And I press the "Enter" key` | `pressKey` | Converted from matched step implementation. |
| `Then I should navigate to "FAQs" page successfully` | `assertVisible` | Converted from matched step implementation. |
| `And the "FAQs" page should load completely` | `assertVisible` | Converted from matched step implementation. |
| `And the security indicator should show a not secure connection` | `assertVisible` | Converted from matched step implementation. |
...
| --- | --- | --- |
| `When I input "http://www.faqs.org/faqs/" in address bar` | `/Users/qunmi/Documents/MS_ADO/FSQ_AI_TestCases_Windows/features/steps/common.py:79` | operations=enter_text |
...
| `Then I should navigate to "FAQs" page successfully` | `/Users/qunmi/Documents/MS_ADO/FSQ_AI_TestCases_Windows/features/steps/core_address_bar/core_address_bar.py:154` | operations=verify_element_exists; locator={"name": "Internet FAQ Archives"} |
| `And the "FAQs" page should load completely` | `/Users/qunmi/Documents/MS_ADO/FSQ_AI_TestCases_Windows/features/steps/core_address_bar/core_address_bar.py:171` | operations=verify_element_exists; locator={"name": "Internet FAQ Archives"} |
| `And the security indicator should show a not secure connection` | `/Users/qunmi/Documents/MS_ADO/FSQ_AI_TestCases_Windows/features/steps/core_address_bar/core_address_bar.py:188` | operations=verify_element_exists; locator={"name": "Not secure"} |
