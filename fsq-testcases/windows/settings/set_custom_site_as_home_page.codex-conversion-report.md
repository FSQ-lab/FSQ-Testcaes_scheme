...
| --- | --- | --- |
| `When I turn on the option "show home button on the toolbar"` | `tapOn` | Conservative semantic conversion. |
| `And I select the option "Set custom site"` | `tapOn` | Conservative semantic conversion. |
| `When I input "https://www.apple.com" to the input box` | `semantic action/assertion` | Conservative semantic conversion. |
| `And I click "Home" button to the left of the address bar` | `tapOn, inputText, pressKey, waitUntil` | Conservative semantic conversion. |
