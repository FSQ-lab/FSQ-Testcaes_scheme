...
| --- | --- | --- |
| `Given I clear downloads folder` | `semantic action/assertion` | Conservative semantic conversion. |
...
| `Then the Downloads panel should appear` | `assert/assertVisible/assertWithAI` | Conservative semantic conversion. |
| `When I navigate to "edge://downloads"` | `tapOn, inputText, pressKey, waitUntil` | Conservative semantic conversion. |
