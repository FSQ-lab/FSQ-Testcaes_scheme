...
- Feature: `bottom_bar`
- Scenario: `Access history through overflow menu`
- Tags: `@p0`

## Output

- Output YAML: `fsq-testcases/android/bottom_bar/access_history_through_overflow_menu.codex.yaml`
- Platform: `android`
...
| `And I tap "History" from the menu` | `tapOn` |  |
| `Then the History panel should open` | `tapOn` | the History panel should open |
| `And the panel title should display "History"` | `tapOn` | the panel title should display "History" |
| `When I close the History panel` | `pressKey` |  |
| `Then I should return to the New Tab Page` | `tapOn` |  |
| `When I open the browser menu by tapping on the three dots icon at the bottom right corner` | `tapOn` |  |
| `And I tap "History" from the menu` | `tapOn` |  |
| `Then the panel title should display "History"` | `tapOn` | the panel title should display "History" |
...
- the History panel should open
- the panel title should display "History"
- the panel title should display "History"
