...
- Feature: `bottom_bar`
- Scenario: `Access favorites through overflow menu`
- Tags: `@p0`

## Output

- Output YAML: `fsq-testcases/android/bottom_bar/access_favorites_through_overflow_menu.codex.yaml`
- Platform: `android`
...
| `And I tap "Favorites" from the menu` | `tapOn` |  |
| `Then the Favorites panel should open` | `tapOn` | the Favorites panel should open |
| `And the panel title should display "Favorites"` | `tapOn` | the panel title should display "Favorites" |
| `When I close the Favorites panel` | `pressKey` |  |
| `Then I should return to the New Tab Page` | `tapOn` |  |
| `When I open the browser menu by tapping on the three dots icon at the bottom right corner` | `tapOn` |  |
| `And I tap "Favorites" from the menu` | `tapOn` |  |
| `Then the panel title should display "Favorites"` | `tapOn` | the panel title should display "Favorites" |
| `When I click the return button on phone navigation bar` | `pressKey` |  |
| `Then I should return to the New Tab Page` | `tapOn` |  |

## Unresolved Or Low-Confidence Items

- the Favorites panel should open
- the panel title should display "Favorites"
- the panel title should display "Favorites"
