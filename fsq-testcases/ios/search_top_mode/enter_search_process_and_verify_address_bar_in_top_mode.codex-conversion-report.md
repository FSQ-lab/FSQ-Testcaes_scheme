...
- Scenario: `Enter search process and verify address bar in top mode`
- Tags: `@p0`

## Output

- Output YAML: `fsq-testcases/ios/search_top_mode/enter_search_process_and_verify_address_bar_in_top_mode.codex.yaml`
- Platform: `ios`
