...
| `And I input "edge://settings/appearance/toolbar" to the address bar` | `tapOn, inputText` |  |
| `When I click on "Home" button on the settings page` | `tapOn` |  |
| `Then the home button should be visible on the toolbar` | `assertVisible` |  |
| `When I click on "Home" button on the settings page` | `tapOn` |  |
| `Then the home button should be hidden on the toolbar` | `assertNotVisible` |  |
