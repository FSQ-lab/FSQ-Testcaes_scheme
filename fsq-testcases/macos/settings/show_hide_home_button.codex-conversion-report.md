...
- Output YAML: `fsq-testcases/macos/settings/show_hide_home_button.codex.yaml`
- Platform: `macos`
...
| `When I click on "Home" button on the settings page` | `tapOn` | Converted from matched step implementation. |
| `Then the home button should be hidden on the toolbar` | `assertNotVisible` | Converted from matched step implementation. |
...
| `When I click on "Home" button on the settings page` | `/Users/qunmi/Documents/MS_ADO/FSQ_AI_Testcases_Mac/features/steps/settings/settings.py:516` | operations=click_element; locator={"xpath": "//XCUIElementTypeSwitch[@label='Home']"} |
| `Then the home button should be visible on the toolbar` | `/Users/qunmi/Documents/MS_ADO/FSQ_AI_Testcases_Mac/features/steps/settings/settings.py:655` | operations=verify_element_exists; locator={"accessibilityId": "Home"} |
| `When I click on "Home" button on the settings page` | `/Users/qunmi/Documents/MS_ADO/FSQ_AI_Testcases_Mac/features/steps/settings/settings.py:516` | operations=click_element; locator={"xpath": "//XCUIElementTypeSwitch[@label='Home']"} |
| `Then the home button should be hidden on the toolbar` | `/Users/qunmi/Documents/MS_ADO/FSQ_AI_Testcases_Mac/features/steps/settings/settings.py:431` | operations=verify_element_not_exists; locator={"xpath": "//XCUIElementTypeToolbar[@label='App "} |
