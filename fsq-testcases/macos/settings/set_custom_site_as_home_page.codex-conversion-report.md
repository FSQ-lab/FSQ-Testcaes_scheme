...
| `And I select the option "Set custom site"` | `tapOn` |  |
| `Then the input box under "Set custom site" can be clicked` | `assertVisible` | the input box under "Set custom site" can be clicked |
| `When I input "https://www.apple.com" to the input box` | `tapOn` | I input "https://www.apple.com" to the input box |
| `And I select the option "Set custom site"` | `tapOn` |  |
| `And I click "Home" button to the left of the address bar` | `tapOn` |  |
| `Then should open "https://www.apple.com" site` | `assertVisible` | should open "https://www.apple.com" site |

## Unresolved Or Low-Confidence Items

- the input box under "Set custom site" can be clicked
- I input "https://www.apple.com" to the input box
- should open "https://www.apple.com" site
