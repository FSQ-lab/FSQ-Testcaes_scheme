...
| `When I click on "Split screen" button switch in Toolbar Settings page` | `tapOn` |  |
| `Then the Split screen button should be visible on the toolbar` | `assertVisible` |  |
| `When I click on "Split screen" button switch in Toolbar Settings page` | `tapOn` |  |
| `Then the Split screen button should be hidden on the toolbar` | `assertNotVisible` |  |
