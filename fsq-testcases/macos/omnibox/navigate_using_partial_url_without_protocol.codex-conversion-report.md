...
- Output YAML: `fsq-testcases/macos/omnibox/navigate_using_partial_url_without_protocol.codex.yaml`
- Platform: `macos`
...
| `When I input "apple.com" in address bar` | `tapOn, inputText` | Converted from matched step implementation. |
...
| `When I input "apple.com" in address bar` | `/Users/qunmi/Documents/MS_ADO/FSQ_AI_Testcases_Mac/features/steps/ominibox/ominibox.py:438` | operations=click_element, send_keys; locator={"accessibilityId": "Address and search bar"} |
