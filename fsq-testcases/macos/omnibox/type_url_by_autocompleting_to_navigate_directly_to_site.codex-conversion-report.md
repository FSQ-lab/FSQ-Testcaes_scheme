...
- Output YAML: `fsq-testcases/macos/ominibox/type_url_by_autocompleting_to_navigate_directly_to_site.codex.yaml`
- Platform: `macos`
...
| `When I type "www.app" in the address bar` | `tapOn, inputText` |  |
