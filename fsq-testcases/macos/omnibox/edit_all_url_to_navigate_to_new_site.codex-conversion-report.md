...
- Output YAML: `fsq-testcases/macos/omnibox/edit_all_url_to_navigate_to_new_site.codex.yaml`
- Platform: `macos`
...
| `And I type "https://www.apple.com" in the address bar` | `inputText` | Converted from matched step implementation. |
...
| `And I type "https://www.apple.com" in the address bar` | `/Users/qunmi/Documents/MS_ADO/FSQ_AI_Testcases_Mac/features/steps/ominibox/ominibox.py:335` | operations=send_keys; locator={"xpath": "//XCUIElementTypeTextField[@label='Address and search bar']"} |
